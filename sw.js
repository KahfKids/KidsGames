const CACHE_NAME = 'kidsgames-v1.0.0';
const STATIC_CACHE = 'kidsgames-static-v1.0.0';
const GAMES_CACHE = 'kidsgames-games-v1.0.0';
const PREMIUM_CACHE = 'kidsgames-premium-v1.0.0';
...
console.log('[SW] KidsGames Service Worker v1.0.0 loaded');